...
<html>
    <head>
        ...
        <title>FishEye: Annotated - fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs</title>
...
<script type="text/javascript">
    ...
    FECRU.beginProcessingTimestamp = "1315330738335";
    FECRU.isAnon = true;
</script>
        ...
        AJS.$("#quick-search-form").delegate("a.quick-search-redo", "menuItemSelected", function(e) {
            ...
            <ul id="header-details">
                    ...
                    <li id="header-details-user" class="detail-drop aui-dd-parent">
                                ...
                                <input type="hidden" id="origUrl" value="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs%3Fr%3D1085%26r%3D1085%26r%3D1085">
                                <a id="login-link" class="lnk"
                                   href="/login?origUrl=/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs%3Fr%3D1085%26r%3D1085%26r%3D1085">
                                    Log In
                                </a>
...
<div id="header-file" class="header filetype-cs">
    ...
    <h3 class="breadcrumbs"><span class="crumbs"><a href="/browse/fest" title="">fest</a><span>/</span><a href="/browse/fest/trunk" title="trunk">trunk</a><span>/</span><a href="/browse/fest/trunk/fest-selenium" title="trunk/fest-selenium">fest-selenium</a><span>/</span><a href="/browse/fest/trunk/fest-selenium/src" title="trunk/fest-selenium/src">src</a><span>/</span><a href="/browse/fest/trunk/fest-selenium/src/dotnet" title="trunk/fest-selenium/src/dotnet">dotnet</a><span>/</span><a href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium" title="trunk/fest-selenium/src/dotnet/JavaSelenium">JavaSelenium</a><span>/</span><a href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties" title="trunk/fest-selenium/src/dotnet/JavaSelenium/Properties">Properties</a></span></h3>
            ...
            <div class="aui-toolbar">
                <ul id="branch-selector-group" class="toolbar-group">
                    <li class="toolbar-item branch-selector active">
                        <a id="select-branch-all" class="toolbar-trigger"
                            href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?wbbr=&wbtag=&wbjump=jump&hb=true&brjump=jump"
                        ...
                        <li class="toolbar-item branch-selector ">
                            <a id="select-branch-default" class="toolbar-trigger"
                                    href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?wbbr=trunk&wbtag=&wbjump=jump&hb=true&brjump=jump"
                ...
                <ul class="toolbar-group edit-group">
                    <li class="toolbar-item">
                        <div>
                            <form method="post" action="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs" id="branch-constraint-form">
...
<script type="text/javascript">
    ...
    AJS.$(document).bind(eventType, function() {
        var opts = {
            ...
            searchOnFocus: false,
            url: "/changelog-ajax/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs",
...
<!-- Tree build time: 34 Node count: 231 -->
...
<li class="tree-li" id="treeli2038372268">

<span id="selectedDirTreeNode" class="file filetype-cs">

<input type="hidden" name="selectedPath" value="trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs">




<a href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&r=1085&r=1085&r=1085" class="fileLink" id="selectedDirTreeLink">AssemblyInfo.cs<input type="hidden" name="anchor" value="trunkZ002ffest-seleniumZ002fsrcZ002fdotnetZ002fJavaSeleniumZ002fPropertiesZ002fAssemblyInfo.cs"/></a></span>
...
<div class="accordion sidebar accordion-charts ">
    <div class="accordion-head">
        ...
        <img width="280" height="32" alt="Line Count Graph" title="" class=""
             ...
             src="/fe/locChart.do?w=280&h=32&context=main-sparkline&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&markEnd=0&markStart=0&imageBackgroundColour=FFFFFF&outputtype=image">
    ...
    <div class="accordion-content ">
        ...
        <img width="276" height="200" alt="Line Count Graph" title="" class=""
             ...
             src="/fe/locChart.do?w=276&h=200&context=main&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&markEnd=0&markStart=0&imageBackgroundColour=FFFFFF&outputtype=image">
...
AJS.$('#locMap').load('/fe/locChart.do?w=276&h=200&context=main&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&markEnd=0&markStart=0&imageBackgroundColour=FFFFFF&outputtype=imagemap&mapName=locMap','');
                });
            </script>
...
AJS.$('#htmlLegend').load('/fe/locChart.do?w=276&h=200&context=main&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&markEnd=0&markStart=0&imageBackgroundColour=FFFFFF&outputtype=htmlLegend&mapName=locMap','');
        });
    </script>
...
<img width="276" height="32" alt="Commits By Day In Week" title="" class=""
     ...
     src="/fe/commitSparkline.do?w=276&h=32&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=image">
...
AJS.$('#SparklineMap').load('/fe/commitSparkline.do?w=276&h=32&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=imagemap&mapName=SparklineMap','');
        });
    </script>
...
<img width="276" height="70" alt="Commits By Day In Week" title="" class=""
     ...
     src="/fe/commitSparkline.do?w=276&h=70&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=image">
...
AJS.$('#SparklineMap').load('/fe/commitSparkline.do?w=276&h=70&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=imagemap&mapName=SparklineMap','');
        });
    </script>
    <div id="SparklineMap" class="hidden">&nbsp;</div>
...
<img width="276" height="70" alt="Commits By Day In Week" title="" class=""
     ...
     src="/fe/commitChartDay.do?w=276&h=70&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=image">
...
AJS.$('#DayMap').load('/fe/commitChartDay.do?w=276&h=70&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=imagemap&mapName=DayMap','');
        });
    </script>
...
<img width="276" height="70" alt="Commits By Hour In Day" title="" class=""
     ...
     src="/fe/commitChartHour.do?w=276&h=70&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=image">
...
AJS.$('#HourMap').load('/fe/commitChartHour.do?w=276&h=70&context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&imageBackgroundColour=FFFFFF&outputtype=imagemap&mapName=HourMap','');
        });
    </script>
...
AJS.$('#activityCalendarDiv').load('/fe/commitCalendar.do?context=changelog&repname=fest&path=trunk%2Ffest-selenium%2Fsrc%2Fdotnet%2FJavaSelenium%2FProperties%2FAssemblyInfo.cs&outputtype=html','');
    });
</script>
...
<div class="accordion sidebar  active">
    <div class="accordion-head">
        <h3>Age</h3>
        <span>
            <img id="file-chart" alt="Age chart" src="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;chart=age&thumb=true"/>
        </span>
    </div>
    <div class="accordion-content accordion-open">
        
                    <img id="file-chart" alt="Age chart" src="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;chart=age" usemap="#age-map"/>

                    <div id="age-map-div">
                            
                    </div>
                    <a id="annotation-link-age" href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;&#64;annm=age">Annotate this</a>
...
<div class="accordion sidebar  active">
    <div class="accordion-head">
        <h3>Blame</h3>
        <span>
            <img id="file-chart" alt="Blame chart" src="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;chart=blame&amp;thumb=true"/>
        </span>
    </div>
    <div class="accordion-content accordion-open">
        
                    <img id="file-chart" alt="Blame chart" src="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;chart=blame" usemap="#blame-map"/>

                    <div id="blame-map-div">
                            
                    </div>
                    <a id="annotation-link-blame" href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;&#64;annm=blame">Annotate this</a>
...
<div class="accordion sidebar  active">
    <div class="accordion-head">
        <h3>Mixed</h3>
        <span>
            <img id="file-chart" alt="Mixed chart" src="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;chart=mixed&amp;thumb=true"/>
        </span>
    </div>
    <div class="accordion-content accordion-open">
        
                    <img id="file-chart" alt="Mixed chart" src="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;chart=mixed" usemap="#mixed-map"/>
...
<li><a class="" href="/changelog/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs">Activity</a></li>

<li><a class="" href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?focusedRev=1085">Revisions</a></li>
<li><a class="" href="/users/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs">Users</a></li>
<li><a class="" href="/reports/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs">Reports</a></li>

    
        <li><a class="active" href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?hb=true" title="Latest revision on HEAD">Source</a></li>
        ...
        <li>
            ...
            <li>
                ...
                <a href="/browse/~raw,r=1085/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs">
                    Raw
                </a>
            </li>
            ...
            <li class="aui-dd-parent selectable">
                ...
                <ul class="aui-dropdown aui-dropdown-left hidden">
                    <li class="selected">
                        <a href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;&#64;annm=age">Age</a>
                    </li>
                    <li >
                        <a href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;&#64;annm=blame">Author</a>
                    </li>
                    <li >
                        <a href="/browse/fest/trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs?r=1085&amp;&#64;annm=none">None</a>
                    </li>
                </ul>
                </div>
            </li>
    ...
    <img class="ide-icon tb_right_mid"
         id="ide-icon2095512623"
         title="Open file trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs in IDE"
         onclick="this.src=CRU.UTIL.createIdeSrc('http://localhost:51235/file?file=trunk/fest-selenium/src/dotnet/JavaSelenium/Properties/AssemblyInfo.cs', null);"
         alt="Open in IDE"
         src="http://localhost:51235/icon">

    <script type="text/javascript">
        AJS.$("#ide-icon2095512623").load(function () {
            AJS.$(this).show();
        });
    </script>
